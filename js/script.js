...
var choixun;//
var choixdeux;//
var norepeat = true;//em"peche le chrono de se repeter
document.getElementById("submit").addEventListener("click", function(){
	document.getElementById("formulairePrenom").style.display = "none";
});
 /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 //                                                                         AFFICHER LES IMAGES                                                         //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
function choisir(carte) { // Choix des cartes quand l'utilisateur clique
 ...
 function recommencer(){
 	document.location.href ="index.php?victoire=false";
 }
...
function verif() { // Vérifie si une paire a été faite
	...
	if (paires==7) {
		...
		document.location.href="index.php?victoire=true&&time="+time;
		}
}
